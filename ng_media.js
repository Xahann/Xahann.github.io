...
(function($) {
	...
	var MediaPlaylist = function(id) {
		...
		self.playFirstItem = function(afterCallback) {
			var self = this;
			self._current_index = -1;
			self.loadNextItem(afterCallback);
		}
...
console.log(url_parts.join('/'),data);
	...
	NgMediaPlayer = function(id, params) {
		...
		self.startPlaylist = function(playlist_id)
		{
			var self = this;
			if (typeof(playlist_id) == 'undefined') playlist_id = self._current_playlist._id;
			self._playlists[playlist_id].playFirstItem();
		};
